...
<head>
    ...
    <title>Innout| Ponto a ponto</title>
</head>
    ...
    <form class="form-login" action="#" method="post">
        ...
        <div class="login-card card">
            ...
            <div class="card-header">
                <i class="ph-bag-simple"></i>
                <span class="font-weight-light m-2">In </span>
                <span class="text2 font-weight-bold">N'</span>
                <span class="font-weight-light m-2">Out</span>
                <i class="ph-person-simple-run m-2"></i>
            </div>
            <div class="card-body">
